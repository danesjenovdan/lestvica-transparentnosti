    ...
    <div class="narrow">
      ...
      <ul>
        <li>
          ...
          vključuje zagotavljanje pravočasnih in ustreznih informacij ter javne
          narave lokalnih procesov odločanja.
        </li>
        <li>
          <strong>Preglednost spletnega mesta in dostop do informacij</strong>,
          kjer smo se osredotočili predvsem na enostavno in uporabniku prijazno
          prikazovanje javnih občinskih podatkov.
        </li>
        <li>
          <strong
      ...
      <p>
        ...
        <span class="highlighted">
          so občine z večjim številom prebivalcev in višjim proračunom praviloma
          bolj odprte in transparentne ter obratno
        </span>
        - manjše občine so v večini primerov manj transparentne in odprte. Pri
        tem predvidevamo, da je v manjših in bolj ruralnih občinah za razliko od
        urbanih središč spletno mesto manj prepoznan kanal obveščanja, nizko
        število točk pa je lahko tudi posledica nezadostnih kadrovskih kapacitet
      ...
      <p>
        ...
        netransparentnega delovanja delovnih teles, velika večina pa tudi zato,
        ker objav o delovanju občinskega sveta ne opremlja z datumi. Ker s tem
        občine ne omogočajo sledljivosti komuniciranja z javnostmi, točk nismo
        priznali tudi, če so iskane informacije na spletnem mestu dejansko
        objavljene.
      </p>
      <p>
        <span class="highlighted">
          Pri preglednosti spletnega mesta in dostopu do informacij so občine v
          povprečju dosegle 8,4 od 20 možnih točk.
        </span>
        ...
        sveta ter pomanjkanja informacij o občinskih svetnikih, s čimer občankam
        in občanom ne omogočajo informiranja o izvoljenih predstavnikih ali pa
        njihovega kontaktiranja.
      </p>
      <p>
        <span class="highlighted">
      ...
      <p>
        <span class="highlighted">
          Pri vključenosti javnosti v delovanje občine ter ustreznem obveščanju
          so občine v povprečju dosegle le 2,1 od 20 točk.
        </span>
        ...
        vprašalnikov niso rešile, smo pri neodgovorjenih kazalnikih pripisali 0
        točk.
      </p>
    </div>
  </content-section>
