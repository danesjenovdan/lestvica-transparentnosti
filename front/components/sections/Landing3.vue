  ...
  <content-section variant="orange">
    ...
    <div class="narrow">
      ...
      <p>
        ...
        ter občanov in jim za svoje delo tudi odgovarjajo. Pri tem pa ključno
        vlogo odigra predvsem dostopnost podatkov, ki omogoča ustrezen nadzor
        nad dejanji in sprejetimi odločitvami svetnic in svetnikov ter tako še
        dodatno dviguje njihovo odgovornost.
      </p>
